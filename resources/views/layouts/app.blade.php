    ...
    <header class="bg-slate-900 text-slate-100 shadow">
        <div class="max-w-screen-2xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3 text-sm">
                ...
                @role('admin')
                    <a href="{{ route('admin.users.index') }}" class="px-3 py-1.5 rounded hover:bg-slate-800 {{ request()->routeIs('admin.users.*') ? 'bg-slate-800' : '' }}">Admin</a>
                    <a href="{{ route('admin.roles.index') }}" class="flex items-center gap-1.5 px-3 py-1.5 rounded hover:bg-slate-800 {{ request()->routeIs('admin.roles.*') ? 'bg-slate-800 text-white' : '' }}">
